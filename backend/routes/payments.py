...
# --- 1. SCANNER ACTIONS (Trigger Fetch) ---
...
def add_service_account(service_type):
    data = request.json
    # Normalize type names for DB (Venmo, PayPal, Zelle)
